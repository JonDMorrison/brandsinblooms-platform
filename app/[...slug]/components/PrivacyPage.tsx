...
export async function PrivacyPage() {
  ...
  // Fetch database content for privacy page sections
  ...
  try {
    ...
    contentResult = await getContentBySlug(supabase, siteId, 'privacy')
    ...
    >
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(generateStructuredData('privacy'))
        }}
      />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose max-w-none" style={{color: 'var(--theme-text)', fontFamily: 'var(--theme-font-body)'}}>
              <p className="text-lg mb-6">
                This privacy policy page is not yet configured. Please use the content editor to set up your privacy policy.
              </p>
            </div>
          </div>
        </div>
