 ...
 * Modal for editing header/navigation settings in Full Site Editor
 * Wraps the existing HeaderCustomization component from dashboard/design
 */
...
import { HeaderCustomization } from '@/src/components/design/header-customization'
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Customize your site header and navigation
          </DialogDescription>
        </DialogHeader>
