 ...
 * Manages add/delete operations for Features section items
...
interface FeaturesItemManagerProps {
...
export function FeaturesItemManager({
  section,
  sectionKey,
  onAdd,
  onDelete
}: FeaturesItemManagerProps) {
  const { data } = section

  // Convert features to typed array
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">
            Manage the feature items displayed in this section
          </p>
        </div>
        <Button
          onClick={onAdd}
      ...
      <div className="p-3 bg-blue-50 rounded-md border border-blue-200">
        <p className="text-xs text-blue-800">
          <strong>Tip:</strong> After adding or deleting features, you can edit their content (title, icon)
