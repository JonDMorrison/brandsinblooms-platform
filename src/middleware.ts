...
import { getSiteFromRedisCache, setSiteInRedisCache } from '@/src/lib/cache/redis-site-cache'
...
/**
 * Next.js middleware for domain-based site resolution
 * Handles incoming requests and resolves sites based on Host header
 */
export async function middleware(request: NextRequest) {
  ...
  try {
    ...
    if (isDevelopmentEnvironment(hostname)) {
      return handleDevelopmentRequest(request, supabaseResponse, hostname)
    }
